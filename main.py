...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://blogz:neenar40@localhost:8889/blogz'
app.config['SQLALCHEMY_ECHO'] = True
db = SQLAlchemy(app)
app.secret_key = 'sw3%loevt$qiswpa'
...
@app.before_request
def require_login():
    allowed_routes = ['login', 'signup', 'index', 'blog', 'Blog Users']
